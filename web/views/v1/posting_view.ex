defmodule PortalApi.V1.PostingView do
  ...
  alias PortalApi.V1.{PostingView, UserView, DepartmentView, JobView, SalaryGradeLevelView, SalaryGradeStepView}
  ...
  def render("posting.json", %{posting: posting}) do
    ...
    |> Map.put(:user, render_one(posting.user, UserView, "user.json"))
  end
