defmodule PortalApi.V1.SalaryGradeStepView do
  ...
  def render("index.json", %{salary_grade_steps: salary_grade_steps}) do
    %{data: render_many(salary_grade_steps, PortalApi.V1.SalaryGradeStepView, "salary_grade_step.json")}
  end

  def render("show.json", %{salary_grade_step: salary_grade_step}) do
    %{data: render_one(salary_grade_step, PortalApi.V1.SalaryGradeStepView, "salary_grade_step.json")}
  end
