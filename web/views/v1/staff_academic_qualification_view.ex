defmodule PortalApi.V1.StaffAcademicQualificationView do
  ...
  def render("index.json", %{staff_academic_qualifications: staff_academic_qualifications}) do
    render_many(staff_academic_qualifications, PortalApi.V1.StaffAcademicQualificationView, "staff_academic_qualification.json")
  end

  def render("show.json", %{staff_academic_qualification: staff_academic_qualification}) do
    render_one(staff_academic_qualification, PortalApi.V1.StaffAcademicQualificationView, "staff_academic_qualification.json")
  end
