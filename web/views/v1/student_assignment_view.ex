defmodule PortalApi.V1.StudentAssignmentView do
  ...
  def render("index.json", %{student_assignments: student_assignments}) do
    %{data: render_many(student_assignments, PortalApi.V1.StudentAssignmentView, "student_assignment.json")}
  end

  def render("show.json", %{student_assignment: student_assignment}) do
    %{data: render_one(student_assignment, PortalApi.V1.StudentAssignmentView, "student_assignment.json")}
  end
