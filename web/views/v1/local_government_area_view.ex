defmodule PortalApi.V1.LocalGovernmentAreaView do
  ...
  def render("index.json", %{local_government_areas: local_government_areas}) do
    %{data: render_many(local_government_areas, PortalApi.V1.LocalGovernmentAreaView, "local_government_area.json")}
  end

  def render("show.json", %{local_government_area: local_government_area}) do
    %{data: render_one(local_government_area, PortalApi.V1.LocalGovernmentAreaView, "local_government_area.json")}
  end
