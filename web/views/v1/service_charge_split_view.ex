defmodule PortalApi.V1.ServiceChargeSplitView do
  ...
  def render("index.json", %{service_charge_splits: service_charge_splits}) do
    render_many(service_charge_splits, PortalApi.V1.ServiceChargeSplitView, "service_charge_split.json")
  end

  def render("show.json", %{service_charge_split: service_charge_split}) do
    render_one(service_charge_split, PortalApi.V1.ServiceChargeSplitView, "service_charge_split.json")
  end
