defmodule PortalApi.V1.FacultyHeadView do
  ...
  def render("index.json", %{faculty_heads: faculty_heads}) do
    render_many(faculty_heads, PortalApi.V1.FacultyHeadView, "faculty_head.json")
  end

  def render("show.json", %{faculty_head: faculty_head}) do
    render_one(faculty_head, PortalApi.V1.FacultyHeadView, "faculty_head.json")
  end
