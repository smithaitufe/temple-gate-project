defmodule PortalApi.V1.StudentContinuousAssessmentView do
  ...
  def render("index.json", %{student_continuous_assessments: student_continuous_assessments}) do
    %{data: render_many(student_continuous_assessments, PortalApi.V1.StudentContinuousAssessmentView, "student_continuous_assessment.json")}
  end

  def render("show.json", %{student_continuous_assessment: student_continuous_assessment}) do
    %{data: render_one(student_continuous_assessment, PortalApi.V1.StudentContinuousAssessmentView, "student_continuous_assessment.json")}
  end
