defmodule PortalApi.V1.CourseEnrollmentView do
  ...
  alias   PortalApi.V1.{CourseEnrollmentView, UserView, CourseView, CourseGradingView, StudentCourseAssessmentView, AcademicSessionView}
  ...
  def render("course_enrollment.json", %{course_enrollment: course_enrollment}) do
    ...
    |> Map.put(:assessments, render_many(course_enrollment.assessments, StudentCourseAssessmentView, "course_enrollment_assessment.json"))
  end
