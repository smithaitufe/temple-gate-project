defmodule PortalApi.V1.StudentProjectSupervisorView do
  ...
  def render("index.json", %{student_project_supervisors: student_project_supervisors}) do
    render_many(student_project_supervisors, PortalApi.V1.StudentProjectSupervisorView, "student_project_supervisor.json")
  end

  def render("show.json", %{student_project_supervisor: student_project_supervisor}) do
    render_one(student_project_supervisor, PortalApi.V1.StudentProjectSupervisorView, "student_project_supervisor.json")
  end
