defmodule PortalApi.V1.TransactionResponseView do
  ...
  def render("index.json", %{transaction_responses: transaction_responses}) do
    render_many(transaction_responses, PortalApi.V1.TransactionResponseView, "transaction_response.json")
  end

  def render("show.json", %{transaction_response: transaction_response}) do
    render_one(transaction_response, PortalApi.V1.TransactionResponseView, "transaction_response.json")
  end
