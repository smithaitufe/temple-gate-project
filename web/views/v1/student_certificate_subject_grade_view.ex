defmodule PortalApi.V1.StudentCertificateSubjectGradeView do
  ...
  def render("index.json", %{student_certificate_subject_grades: student_certificate_subject_grades}) do
    render_many(student_certificate_subject_grades, PortalApi.V1.StudentCertificateSubjectGradeView, "student_certificate_subject_grade.json")
  end

  def render("show.json", %{student_certificate_subject_grade: student_certificate_subject_grade}) do
    render_one(student_certificate_subject_grade, PortalApi.V1.StudentCertificateSubjectGradeView, "student_certificate_subject_grade.json")
  end
