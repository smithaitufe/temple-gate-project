defmodule PortalApi.Router do
  ...
  scope "/api", PortalApi do
    ...
    scope "/v1", V1, as: :v1 do
      ...
      resources "/post_secondary_certificates", PostSecondaryCertificateController, except: [:new, :edit]
      resources "/post_primary_certificates", PostPrimaryCertificateController, except: [:new, :edit]
      resources "/post_primary_certificate_items", PostPrimaryCertificateItemController, except: [:new, :edit]
