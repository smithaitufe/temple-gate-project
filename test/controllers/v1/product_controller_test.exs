defmodule PortalApi.V1.ProductControllerTest do
  use PortalApi.ConnCase

  alias PortalApi.V1.Product
  @valid_attrs %{available_at: %{day: 17, month: 4, year: 2010}, description: "some content", is_negotiable: true, is_sold: true, long_description: "some content", name: "some content", price: "120.5", quantity: 42, unavailable_at: %{day: 17, month: 4, year: 2010}}
  @invalid_attrs %{}
